...
while true; do
  ...
  echo -e "${YELLOW}6) Certificate management${RESET}" # Certificate management
  echo -e "${RED}7) Uninstall TrustTunnel${RESET}" # Uninstall TrustTunnel
  echo -e "${WHITE}8) Exit${RESET}" # Exit
